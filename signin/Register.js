        ...
        <SafeAreaView style={{marginLeft: 20, marginRight: 20 }}>
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View>
                    ...
                    <TextInput style={{fontSize:20, borderColor: '#dee2e6', borderWidth: 1, borderRadius: 5, paddingVertical: 12, paddingHorizontal: 12 }}></TextInput>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center' ,marginTop:20, marginBottom:10}}>
                    <TouchableOpacity style={{width:'100%', elevation: 8,borderRadius: 10, paddingVertical: 15, paddingHorizontal: 12,backgroundColor:'#dc3545',}}>
